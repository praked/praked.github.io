...
![Median paired Δ flock area vs γ, relative to uniform Couzin baseline](/assets/img/SailSwarmSim/uni_couzin_median_delta_area.png "Median paired Δ flock area vs uniform Couzin baseline"){:.lead}
...
![Median paired Δ cumulative collisions vs γ, relative to uniform Couzin baseline](/assets/img/SailSwarmSim/uni_couzin_median_delta_collisions.png "Median paired Δ collisions vs uniform Couzin baseline"){:.lead}
...
![Median paired Δ polarisation vs γ, relative to uniform Couzin baseline](/assets/img/SailSwarmSim/uni_couzin_median_delta_polarisation.png "Median paired Δ polarisation vs uniform Couzin baseline"){:.lead}
...
![Median paired Δ flock area vs γ, relative to γ=0 with luffing](/assets/img/SailSwarmSim/median_delta_area.png "Median paired Δ flock area vs γ=0 with luffing"){:.lead}
...
![Median paired Δ cumulative collisions vs γ, relative to γ=0 with luffing](/assets/img/SailSwarmSim/median_delta_collisions.png "Median paired Δ collisions vs γ=0 with luffing"){:.lead}
...
![Median paired Δ polarisation vs γ, relative to γ=0 with luffing](/assets/img/SailSwarmSim/median_delta_polarisation.png "Median paired Δ polarisation vs γ=0 with luffing"){:.lead}
